...
#
# BRAM_Test_2.tcl: Tcl script for re-creating project 'BRAM_Test_2'
#
# Generated by Vivado on Thu Feb 01 13:42:34 +1000 2024
...
#
# 1. This project restoration tcl script (BRAM_Test_2.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/aidan/Portfolio/FPGA Designs/BRAM_Test_2/BRAM_Test_2.srcs/sources_1/new/adc_to_bram.vhd"
#    "C:/Users/aidan/Portfolio/FPGA Designs/BRAM_Test_2/BRAM_Test_2.srcs/sources_1/bd/system/ip/system_blk_mem_gen_0_0.coe"
#    "C:/Users/aidan/Portfolio/FPGA Designs/BRAM_Test_2/BRAM_Test_2.srcs/utils_1/imports/synth_1/system_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "C:/Users/aidan/Downloads/RedPitaya-FPGA/prj/Examples/Stopwatch/cfg/clocks.xdc"
#    "C:/Users/aidan/Downloads/RedPitaya-FPGA/prj/Examples/Stopwatch/cfg/ports.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../../../../../BRAM_Test_2/BRAM_Test_2.srcs/sources_1/new/adc_to_bram.vhd"]"\
 "[file normalize "$origin_dir/../../../../../../BRAM_Test_2/BRAM_Test_2.srcs/sources_1/bd/system/ip/system_blk_mem_gen_0_0.coe"]"\
 "[file normalize "$origin_dir/../../../../../../BRAM_Test_2/BRAM_Test_2.srcs/utils_1/imports/synth_1/system_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/../../../../../../../../Downloads/RedPitaya-FPGA/prj/Examples/Stopwatch/cfg/clocks.xdc"]"\
 "[file normalize "$origin_dir/../../../../../../../../Downloads/RedPitaya-FPGA/prj/Examples/Stopwatch/cfg/ports.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../../../../../../../../Downloads/RedPitaya-FPGA/prj/Examples/Stopwatch/tmp/cores"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "BRAM_Test_2"
...
set script_file "BRAM_Test_2.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../../../../BRAM_Test_2"]"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../../../../../../../../Downloads/RedPitaya-FPGA/brd"]" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../../../../../../Downloads/RedPitaya-FPGA/prj/Examples/Stopwatch/tmp/cores"]" $obj
...
set file "ip/system_blk_mem_gen_0_0.coe"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
set file "[file normalize "$origin_dir/../../../../../../../../Downloads/RedPitaya-FPGA/prj/Examples/Stopwatch/cfg/clocks.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../../../../../../../Downloads/RedPitaya-FPGA/prj/Examples/Stopwatch/cfg/clocks.xdc"
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../../../../../../../../Downloads/RedPitaya-FPGA/prj/Examples/Stopwatch/cfg/ports.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../../../../../../../Downloads/RedPitaya-FPGA/prj/Examples/Stopwatch/cfg/ports.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
if { [get_files [list adc_to_bram.vhd]] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/aidan/Portfolio/FPGA Designs/BRAM_Test_2/BRAM_Test_2.srcs/sources_1/new/adc_to_bram.vhd
}
...
# adc_to_bram
  ...
  # Create ports
  set adc_dat_a_in_0 [ create_bd_port -dir I -from 13 -to 0 adc_dat_a_in_0 ]
  set adc_dat_b_in_0 [ create_bd_port -dir I -from 13 -to 0 adc_dat_b_in_0 ]
  set adc_clk_source_0 [ create_bd_port -dir O -from 1 -to 0 adc_clk_source_0 ]
  set adc_cdcs_out_0 [ create_bd_port -dir O adc_cdcs_out_0 ]
...
\
  ...
  connect_bd_net -net adc_dat_a_in_0_1 [get_bd_ports adc_dat_a_in_0] [get_bd_pins adc_to_bram_0/adc_dat_a_in]
  connect_bd_net -net adc_dat_b_in_0_1 [get_bd_ports adc_dat_b_in_0] [get_bd_pins adc_to_bram_0/adc_dat_b_in]
  connect_bd_net -net adc_to_bram_0_adc_cdcs_out [get_bd_pins adc_to_bram_0/adc_cdcs_out] [get_bd_ports adc_cdcs_out_0]
  connect_bd_net -net adc_to_bram_0_adc_clk_source [get_bd_pins adc_to_bram_0/adc_clk_source] [get_bd_ports adc_clk_source_0]
  connect_bd_net -net adc_to_bram_0_bram_address [get_bd_pins adc_to_bram_0/bram_address] [get_bd_pins blk_mem_gen_1/addra]
  connect_bd_net -net adc_to_bram_0_bram_data [get_bd_pins adc_to_bram_0/bram_data] [get_bd_pins blk_mem_gen_1/dina]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins axi_gpio_0/gpio2_io_o] [get_bd_pins blk_mem_gen_1/addrb]
  connect_bd_net -net blk_mem_gen_1_doutb [get_bd_pins blk_mem_gen_1/doutb] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_125M/slowest_sync_clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins blk_mem_gen_1/clka] [get_bd_pins blk_mem_gen_1/clkb] [get_bd_pins adc_to_bram_0/adc_clk]
  ...
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn [get_bd_pins rst_ps7_0_125M/peripheral_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins adc_to_bram_0/adc_rst_in]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins blk_mem_gen_1/wea]

  # Create address segments
  assign_bd_address -offset 0x42000000 -range 0x00004000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
...
if { [get_property IS_LOCKED [ get_files -norecurse [list system.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../../../../BRAM_Test_2/BRAM_Test_2.gen/sources_1/bd/system/hdl/system_wrapper.v" ]
} else {
...
set_property -name "incremental_checkpoint" -value "$proj_dir/BRAM_Test_2.srcs/utils_1/imports/synth_1/system_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/BRAM_Test_2.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/BRAM_Test_2.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/BRAM_Test_2.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
