...
HD_PWD='C:/Users/aidan/csse4010_assesment_2/csse4010_assesment_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log combinational_lock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source combinational_lock.tcl -notrace
