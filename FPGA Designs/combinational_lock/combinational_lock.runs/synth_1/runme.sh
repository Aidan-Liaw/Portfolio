...
HD_PWD='C:/Users/aidan/csse4010_assesment_2/csse4010_assesment_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log combinational_lock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source combinational_lock.tcl
