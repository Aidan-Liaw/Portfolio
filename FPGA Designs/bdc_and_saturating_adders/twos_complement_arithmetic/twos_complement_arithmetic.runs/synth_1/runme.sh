...
HD_PWD='C:/Users/aidan/twos_complement_arithmetic/twos_complement_arithmetic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_adders.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcd_adders.tcl
