...
HD_PWD='C:/Users/aidan/twos_complement_arithmetic/twos_complement_arithmetic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_adders.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bcd_adders.tcl -notrace
