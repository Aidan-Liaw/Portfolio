...
HD_PWD='C:/Users/aidan/Portfolio/FPGA Designs/adc_to_ps_2/adc_to_ps_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log processing_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source processing_system_wrapper.tcl
