...
HD_PWD='C:/Users/aidan/Portfolio/FPGA Designs/adc_to_ps_2/adc_to_ps_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log processing_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source processing_system_wrapper.tcl -notrace
