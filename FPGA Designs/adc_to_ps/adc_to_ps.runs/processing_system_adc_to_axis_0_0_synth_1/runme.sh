...
HD_PWD='C:/Users/aidan/Portfolio/FPGA Designs/adc_to_ps/adc_to_ps.runs/processing_system_adc_to_axis_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log processing_system_adc_to_axis_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source processing_system_adc_to_axis_0_0.tcl
