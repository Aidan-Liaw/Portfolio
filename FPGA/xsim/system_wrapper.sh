...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xilinx_vip -L xpm -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_15 -L processing_system7_vip_v1_0_17 -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_2 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_31 -L proc_sys_reset_v5_0_14 -L generic_baseblocks_v2_1_1 -L fifo_generator_v13_2_9 -L axi_data_fifo_v2_1_28 -L axi_register_slice_v2_1_29 -L axi_protocol_converter_v2_1_29 -L blk_mem_gen_v8_4_7 -L xlconstant_v1_1_8 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot system_wrapper xil_defaultlib.system_wrapper xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim system_wrapper -key {Behavioral:sim_1:Functional:system_wrapper} -tclbatch cmd.tcl -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_15 processing_system7_vip_v1_0_17 axi_lite_ipif_v3_0_4 lib_cdc_v1_0_2 interrupt_control_v3_1_5 axi_gpio_v2_0_31 proc_sys_reset_v5_0_14 generic_baseblocks_v2_1_1 fifo_generator_v13_2_9 axi_data_fifo_v2_1_28 axi_register_slice_v2_1_29 axi_protocol_converter_v2_1_29 blk_mem_gen_v8_4_7 xlconstant_v1_1_8)
