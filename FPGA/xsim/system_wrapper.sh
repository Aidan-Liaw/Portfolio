...
simulate()
{
  xsim system_wrapper -key {Behavioral:sim_1:Functional:system_wrapper} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_44e3.protoinst" -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_15 processing_system7_vip_v1_0_17 axi_bram_ctrl_v4_1_9 xlconstant_v1_1_8 lib_cdc_v1_0_2 proc_sys_reset_v5_0_14 smartconnect_v1_0 axi_register_slice_v2_1_29 blk_mem_gen_v8_4_7)
