...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xilinx_vip -L xpm -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_15 -L processing_system7_vip_v1_0_17 -L xil_defaultlib -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_2 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_31 -L proc_sys_reset_v5_0_14 -L blk_mem_gen_v8_4_7 -L xlconstant_v1_1_8 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot test_record_control xil_defaultlib.test_record_control xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim test_record_control -key {Behavioral:sim_1:Functional:test_record_control} -tclbatch cmd.tcl -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_15 processing_system7_vip_v1_0_17 axi_lite_ipif_v3_0_4 lib_cdc_v1_0_2 interrupt_control_v3_1_5 axi_gpio_v2_0_31 proc_sys_reset_v5_0_14 blk_mem_gen_v8_4_7 xlconstant_v1_1_8)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb test_record_control.wdb xsim.dir libdpi.so)
